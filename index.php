...
try {
  ...
  $stmt = $conn->prepare("SELECT * FROM experiences WHERE is_archived = 0 ORDER BY sort_order ASC, exp_id DESC");
  $stmt->execute();
...
<body>
  ...
  <script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script>
    ...
    <div id="testimonialModal" class="custom-testimonial-modal" tabindex="-1" aria-labelledby="testimonialModalLabel" aria-hidden="true"
      role="dialog">
